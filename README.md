...
1. Choose one MVPD model, set model parameters, input functional data and ROI masks, set output directory in [mvpd/model_settings.py](model/model_settings.py);
